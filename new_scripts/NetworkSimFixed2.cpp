...
int main(int argc, char *argv[]) /**/
{
    ...
    // We will make networks according to how many k or P values there are and iterate over all of these values.
    ...
    { // runs the entire code for each percent internal (P) value or degree (k) value
        ...
        // creating fstreams for the 5 measures. This is where the measures and their squares will go.
        fstream outFilePart;
